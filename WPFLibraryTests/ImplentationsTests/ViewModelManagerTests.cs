...
namespace WPFLibraryTests
{
    ...
    {
        private IOnPropertyChangedInterceptor _onPropertyChangedInterceptor;
        ...
        public void SetUp()
        {
            ...
            _onPropertyChangedInterceptor = MockRepository.GenerateMock<IOnPropertyChangedInterceptor>();
            _viewModelManager = new ViewModelManager(_serviceLocator,_onPropertyChangedInterceptor);
        }
